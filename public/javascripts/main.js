...
Vue.component('mobilefifthpage', {
    ...
    methods: {
        showedIcons: function showedIcons() {
            var _this = this;

            this.showIcons1 = !this.showIcons1;
            setTimeout(function () {
                _this.showIcons2 = !_this.showIcons2;
            }, 300);
            setTimeout(function () {
                _this.showIcons3 = !_this.showIcons3;
            }, 600);
            setTimeout(function () {
                _this.showIcons4 = !_this.showIcons4;
            }, 900);
        }
    }
